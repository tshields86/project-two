...
var songQuery = 'https://api.musixmatch.com/ws/1.1/track.search?format=jsonp&q_track=' + song + '&q_artist=' + artist + '&f_has_lyrics=1&apikey=' + process.env.MUSIXMATCH;
...
$.ajax({
  ...
  var  lyricQuery = 'https://api.musixmatch.com/ws/1.1/track.lyrics.get?format=jsonp&track_id=' + info.trackId + '&apikey=' + process.env.MUSIXMATCH;
